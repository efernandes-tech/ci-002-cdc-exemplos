        ...
        if (!$this->upload->do_upload('image')) {
            ...
            if($this->input->post('width') || $this->input->post('height')){
                ...
                if(!$resize['status']){
                    ...
                    $data['info_upload']['thumb_path'] = $data['info_upload']['file_path']
                        ."/resized/".$data['info_upload']['raw_name']
            ...
            if($this->input->post('rotation')){
                ...
                if(!$rotate['status']){
                    ...
                    $data['info_upload']['thumb_path'] = $data['info_upload']['file_path']
                        ."/rotated/".$data['info_upload']['raw_name']
                        .$data['info_upload']['file_ext'];
                }
            }
            ...
            if($this->input->post('crop')){
                ...
                if(!$crop['status']){
                    ...
                    $data['info_upload']['thumb_path'] = $data['info_upload']['file_path']
                        ."/cropped/".$data['info_upload']['raw_name']
                        .$data['info_upload']['file_ext'];
                }
            }
            ...
            if($this->input->post('watermark')){
                ...
                if(!$wm['status']){
                    ...
                    $data['info_upload']['wm_path'] = $data['info_upload']['file_path']
                        ."/watermark/".$data['info_upload']['raw_name']
                        .$data['info_upload']['file_ext'];
                }
            }
        }
